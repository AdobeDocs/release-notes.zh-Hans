...
查看Experience League上[即将举办的](https://experienceleague.adobe.com/zh-hans/events)和[按需](https://experienceleague.adobe.com/zh-hans/docs/events/experience-league-recorded-events/overview)活动的完整列表。
...
| **错误修复和改进** | <ul><li>Slack 通知 - 按计划显示提醒消息</li><li>已停用产品事件不应显示在概览页面上</li><li>_已关闭_ > _已消除的 CSO_ 更新消息和通知未发送</li><li>Status 网页页眉和页脚在刷新时需要很长时间加载</li><li>页脚上的 Status 本地化菜单损坏</li></ul> |
