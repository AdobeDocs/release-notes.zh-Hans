...
| 产品/时间名称 | 类型 | 描述 |
| -----------|---------- | ----|
| **Experience League Showcase** | 竞赛 | 告诉 Adobe 您如何集成 Experience Cloud 产品来创建创新和个性化的客户体验。 提交您的故事并获得 Adobe 的认可！ **9 月 9 日到 29 日接受的条目** – [详细信息](https://experienceleaguecommunities.adobe.com/t5/experience-league-showcase-2022/con-p/exl-showcase-2022?sdid=3NQZB6J7&amp;mv=email) |
| **[!DNL Adobe Workfront]** | 研讨会 | 绘制工作流 – 加入客户成功团队，进行现场讨论并演练绘制工作流（从引入到完成），并了解如何为有效的工作管理实践奠定坚实的基础。 <p>**9 月 20 日** - [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,hKbbhANIJ0GUZ80-hyYRPQ,eHZZsesEKEW-f54PGw4z9w,8IgA8CD5yEyKFei9pwlDJA,iACjdG_hK0m1uoTTaMinZA,TEaHrWBF3USQb49XCqymTg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 网络研讨会 | _系统管理员基础知识：资源管理快速入门_ – DREAM 使用 Adobe [!DNL Workfront] 管理资源 – 了解需要完成的工作、可以访问的资源，并根据可用性分配资源。 加入我们，学习如何操作。<p>**9 月 21 日上午 8:00 UK** - [详细信息和注册](https://webinars.on24.com/adobe_workfront/AdminEssentialsRM?partnerref=exl) |
| **[!DNL Adobe Workfront]** | 研讨会 | _价值实现系列：为项目模板提供案例_ – 加入我们，讨论[!UICONTROL 项目模板]以及它们为组织增加价值和创造效率的不同方式。 我们集思广益，想出不同的方法来构建模板，以支持您的项目 – 按活动、按可交付结果等等。 我们演示了一些收藏夹，并浏览了我们的最新蓝图。 <p>**9 月 21 日下午 12:30 MT** - [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,fir0yEdzREq77VYkVxk2kw,W3nJ9w4q-U69PVqUTk7D6Q,zs6GtWtgRkyikfMUMzBEmw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 研讨会 | _让您和您的用户走上正轨的 10 个沟通技巧_ – 有效的沟通是您、您的用户乃至最终公司成功不可或缺的一部分。 本研讨会提供了十个技巧，包括 [!DNL Workfront] 内外的技巧，以帮助提高绩效、生产力，并降低不必要问题的风险。 <p>**9 月 22 日下午 7:00 MT** - [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,Jcg3aU0zf0uG9pB-_vmCUg,pdnZcB-mqk2_nMKUQEQnsA,xYRXQWa6OU6_tvNTp_vuFQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Campaign Classic]** 和 **[!DNL Adobe Campaign Standard]** | 研讨会 | _社区问答喝咖啡休息时间_ – 加入 Tamara Wulf 和 Earl Ross，谈谈您对 [!DNL Adobe Campaign] 内部网络研讨会中讨论的主题的疑问，即对&#x200B;_节假日和忘记成功营销检查清单的疑问_。 <p>**9 月 22 日下午 8:00 MT** - [详细信息和注册](https://adobe.ly/3KHrGpl) |
| **[!DNL Adobe Workfront]** | 研讨会 | _使用仪表板推动采用率：规划人员_ – 加入客户成功团队，我们将继续基于 [!DNL Adobe Workfront] 角色推出新仪表板系列。 本会议重点关注您的规划人员，他们通常担任项目或计划管理角色。 学习如何建立一个积极主动、以团队为导向的活动意识和责任空间。 <p>**9 月 27 日上午 9:00 MT** - [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,hKbbhANIJ0GUZ80-hyYRPQ,eHZZsesEKEW-f54PGw4z9w,Y1He1usOwUaIvlln-RiUCw,PbQY6cwRBkiHr0Uxk8YBow,2QMMEWx0e0C65kbQ1d4cIA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 研讨会 | _价值实现系列：规划您的 Workfront 历程_ – 您的 Workfront 历程的下一步是什么？加入我们，讨论如何在您的组织中创建您自己的 Adobe Workfront 路线图。 我们将分享一些关于我们最喜欢的里程碑的想法，以添加到您的路线图中，以及我们作为前系统管理员的经验。<p>**10 月 4 日下午 12:30 MT** - [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,Bx3LyyABjkC6f0LfiHlHgw,F_Tenijn5UulPjqprok8eg,7lni6LpvlEWagR1OIDfosA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 研讨会 | _CS Connections：共享战略最佳实践_ – 寻找机会与其他客户联系并讨论 Workfront 功能？ 加入我们的 CS Connections 系列！  每月有机会与其他客户联系，讨论组织的热门话题。 我们将与系统管理员一起进行头脑风暴，解决难题、分享想法，并讨论最佳实践。 <p>**日期：** 10 月 10 日 @ 上午 7:00 MT [详细信息和注册](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,gw8sK1IYp0qugO85lvn9HA,1hAkk731fE2cuzI1JCe2Aw,Lox5X4bDSUC_HaF3SDUy7A?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
...
计划发布日期：**2022 年 9 月 28 日**

* [Experience Platform 发行说明](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) – （2022 年 8 月 24 日）

### [!DNL Adobe Mobile] SDK

更新日期：**2022 年 9 月 1 日** – 请参阅 Adobe Experience Platform Mobile SDK 的[发行说明和更改日志](https://aep-sdks.gitbook.io/docs/release-notes)。

## ![图标](/assets/analytics.png) [!DNL Adobe Analytics] {#analytics}

下一发布日期：**2022 年 9 月 14 日**
...
* AEM 用户组会议 | Adobe PTP，班加罗尔| 2022 年 9 月 30 日 | [在此注册](https://adobe.ly/3DlsUos) | [在社区会话上交谈](https://adobe.ly/3DhQwub)。
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 9 月 | [营销人员决策管理快速入门](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2020.1.offerdecisioning) | 视频 | 了解 Adobe Journey Optimizer 的决策管理功能。 本课程专为希望通过向客户提供优质产品而提高收入、客户体验和忠诚度的营销人员设计而成。 |
...
| 发布日期 | 名称 | 类型 | 描述 | 应用程序 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2022 年 9 月 | [注册开发人员帐户](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/sign-up-developer-account.html?lang=zh-Hans) | 视频 | 在&#x200B;_Acrobat Sign Embed 快速入门指南_&#x200B;第 1 部分中，学习如何注册 Acrobat Sign API 开发人员帐户。 您的新开发人员帐户已完全启用签名和 API 功能。 | 文档服务 |
| 2022 年 9 月 | [创建您的应用程序](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/creating-your-application.html?lang=zh-Hans) | 视频 | 在&#x200B;_Acrobat Sign Embed 快速入门指南_&#x200B;第 2 部分中，了解如何使用 Acrobat Sign API 创建应用程序。 | 文档服务 |
| 2022 年 9 月 | [创建嵌入链接](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/creating-an-embed-link.html?lang=zh-Hans) | 视频 | 在&#x200B;_Acrobat Sign Embed 快速入门指南_&#x200B;第 3 部分中，了解如何为 OAuth 创建嵌入链接。 您的应用程序使用此 OAuth 方法获取用户的权限。 | 文档服务 |
| 2022 年 9 月 | [生成访问令牌](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/generating-an-access-token.html?lang=zh-Hans) | 视频 | 在&#x200B;_Acrobat Sign Embed 快速入门指南_&#x200B;第 4 部分中，了解如何生成可与 Acrobat Sign API 一起使用的访问令牌。 | 文档服务 |
| 2022 年 9 月 | [创建临时文档](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/creating-a-transient-document.html?lang=zh-Hans) | 视频 | 在&#x200B;_Acrobat Sign Embed 快速入门指南_&#x200B;第 5 部分中，了解如何创建临时文档。 | 文档服务 |
...
| 2022 年 9 月 | [创建报告图表](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-report.html?lang=zh-Hans) | 视频（更新） | 了解如何使用新的报告体验在个性化视图中构建、保存和管理您自己的自定义报告和数据导出。 | Acrobat Sign |
