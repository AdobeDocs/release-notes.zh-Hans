...
| 更新“移动设备”维度 | 2018 年 10 月 16 日 | 9 月 26 日，Adobe 将其设备查找功能更新为 Device Atlas 的 2.1 API。这使得一些浏览器的移动设备维度中出现了更详细的设备（例如，Apple iPhone 7、Apple iPhone 8 Plus等）。这种新级别的设备详细信息应定向使用，因为目前并未扩展到所有设备和浏览器类型。 |
