...
| 2024 年 6 月 | [[!DNL AEMaaCS]：如何使用管理员权限访问预览层的存储库浏览器](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-24457) | 新文章 | 了解如何使用自定义工作流显示所有节点，因为默认情况下，预览层的存储库浏览器不会显示所有节点（例如， `/conf`、`/home` 和 `/var` 是不可见的。） |
