...
* **WORKFRONT** | 客户研讨会 | _学习：Adobe Workfront 中的 10 个文本模式技巧_ | 想要通过文本模式扩展您的报告知识吗？不用再找了！该研讨会将简要介绍文本模式基础知识和 API Explorer，然后介绍 Adobe Workfront 中的 10 个文本模式技巧。| **太平洋时间 4 月 18 日上午 9:00** | [登记](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,--xUIfX6gEqCcuYNDuE5IA,S8LJKpyI4kywiEO88_bvdg,Z6HaWjLNV0CaMzwT0JeWQg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* 没有公开的文档涉及如何将自定义属性添加到现成的索引定义。了解有关[添加自定义属性](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/integrations/workfront-connector-configure.html?lang=zh-Hans#metadata-schema-mapping)的详细信息。
