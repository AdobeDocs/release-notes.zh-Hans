...
| 2024 年 5 月 | [循环依赖于[!UICONTROL 架构扩展]错误](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-24175) | 新文章 | 了解出现以下 [!DNL Adobe Campaign Classic] 错误时的解决方案：循环依赖于[!UICONTROL 架构扩展。]`nms:recipient` |
...
|May 2024|[Discover the new Journey Designer](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/create-journeys/new-journey-designer)|Video |Discover the new redesigned journey canvas and how to leverage live reporting in journeys.| -->
