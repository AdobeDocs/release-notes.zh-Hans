...
在Experience League上查看所有[即将举行的活动](https://experienceleague.adobe.com/events/)或浏览[活动录制](https://experienceleague.adobe.com/docs/events/experience-league-recorded-events/overview.html)。
...
| 2023 年 12 月 | Platform、Journey Optimizer | [用决策管理创建和显示产品建议](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers.html) | 文章 | 了解如何用 [!DNL Experience Platform Mobile SDK] 在您的移动应用程序中显示来自 [!DNL Journey Optimizer] [!UICONTROL 决策管理]的产品建议。 |
...
| 2023 年 12 月 | 轮廓 | [创建计算属性以合计购买金额](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases.html) | 视频 | 了解如何使用计算属性合计用户在多个销售渠道上购买的金额。 |
...
| 2023 年 12 月 | [[!DNL AEP] - 当源架构不符合 [!DNL XDM] 时，流式处理轮廓更新失败](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23026.html) | 新文章 | 了解在流式处理轮廓“[!DNL upsert]”时，如果源架构不符合 [!DNL XDM]，则数据流失败。 |
| 2023 年 12 月 | [[!DNL AEP] - 许可证用量部分中可找到的受众与主页上的轮廓数不同](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23025.html) | 新文章 | 了解许可证用量部分中可找到的受众何时与主页上的轮廓数不同。 |
