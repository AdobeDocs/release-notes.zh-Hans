...
真实用户监控 (RUM) 数据服务能够更准确地反映用户交互，确保可靠地衡量网站参与度。这是一个深入了解页面性能的绝佳机会。但这对于使用Adobe管理的CDN或非Adobe管理的CDN的客户是有益的。 此外，对于使用非 Adobe 管理的 CDN 的客户，现在可为其启用自动流量报告，这样即无需与 Adobe 共享任何流量报告。

如果您有兴趣测试这项新功能并分享您的反馈，请将电子邮件发送到 [aemcs-rum-adopter@adobe.com](mailto:aemcs-rum-adopter@adobe.com)，其中需含有您的生产、暂存和开发环境的域名。请从与您的 Adobe ID 关联的电子邮件地址发送这封电子邮件。然后，Adobe的产品团队将为您启用Real User Monitoring (RUM)数据服务。
...
* [随 Cloud Manager 的 2023 年 10 月版本一起公布并开始](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0.html?lang=zh-Hans)的[构建环境](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=zh-Hans)的更新现已推出完毕。
   ...
   * Maven已更新至版本3.8.8。
      * Maven现在默认禁用所有不安全的`http://*`镜像。
      * [Adobe建议](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=zh-Hans)用户更新其Maven存储库以使用HTTPS而不是HTTP。
...
* 授权[!DNL Workfront]用户始终收到身份验证失败错误日志。
