...
| 发布日期 | 应用程序 | 名称 | 类型 | 描述 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023 年 12 月 | Mobile SDK | [“在移动应用程序中实施 Adobe Experience Cloud”教程](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html?lang=zh-Hans) | 更新的教程（多篇文章） | 了解如何使用 Adobe [!DNL Experience Platform Mobile SDK] 在您的移动应用程序中实施 Adobe [!DNL Experience Cloud] 应用程序。 |
| 2023 年 12 月 | Platform、Journey Optimizer | [创建和发送推送通知](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push.html?lang=zh-Hans) | 文章 | 了解如何用 [!DNL Experience Platform Mobile SDK] 和 [!DNL Journey Optimizer] 为移动应用程序创建推送通知。 |
| 2023 年 12 月 | Mobile SDK、Journey Optimizer | [创建和发送应用程序内消息](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp.html?lang=zh-Hans) | 文章 | 了解如何用 [!DNL Experience Platform Mobile SDK] 和 [!DNL Journey Optimizer] 为移动应用程序创建应用程序内消息。 |
| 2023 年 12 月 | Platform、Journey Optimizer | [用决策管理创建和显示产品建议](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers.html?lang=zh-Hans) | 文章 | 了解如何用 [!DNL Experience Platform Mobile SDK] 在您的移动应用程序中显示来自 [!DNL Journey Optimizer] [!UICONTROL 决策管理]的产品建议。 |
| 2023 年 12 月 | 管理 | [添加产品管理员](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-product-administrators.html?lang=zh-Hans) | 视频 | 了解如何在 [!DNL Admin Console] 中添加 Adobe [!DNL Experience Platform] 的新管理员。管理员可以添加和管理其他管理员、用户、开发人员和 API 凭据。 |
| 2023 年 12 月 | 管理 | [添加开发人员并授予对 API 凭据的权限](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-developers.html?lang=zh-Hans) | 视频 | 了解如何将开发人员添加到 [!DNL Real-Time Customer Data Platform] 和 [!DNL Journey Optimizer] 等基于 Adobe Experience Platform 的应用程序。 |
| 2023 年 12 月 | 管理 | [添加用户和管理权限](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-users.html?lang=zh-Hans) | 更新的视频 | 了解如何在 [!DNL Real-Time Customer Data Platform] 和 [!DNL Journey Optimizer] 等基于 Adobe Experience Platform 的应用程序中添加用户和管理权限。 |
| 2023 年 12 月 | 数据收集 | [创建数据流](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream.html?lang=zh-Hans) | 视频 | 了解如何在 Experience Platform 中创建数据流。 |
| 2023 年 12 月 | 数据收集 | [配置标记属性](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags.html?lang=zh-Hans) | 视频 | 了解如何在[!UICONTROL 数据收集]界面中配置标记属性。 |
| 2023 年 12 月 | 数据收集 | [安装 Adobe Experience Platform Mobile SDK](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/app-implementation/install-sdks.html?lang=zh-Hans) | 文章 | 了解如何在移动应用程序中实施 Adobe [!DNL Experience Platform Mobile SDK]。 |
| 2023 年 12 月 | 轮廓 | [创建计算属性以合计购买金额](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases.html?lang=zh-Hans) | 视频 | 了解如何使用计算属性合计用户在多个销售渠道上购买的金额。 |
| 2023 年 12 月 | 数据收集 | [创建标记属性](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-a-property.html?lang=zh-Hans)。 | 更新的视频 | 了解如何创建标记属性以管理网站上的营销标记。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|----|----|-----------|
| 2023 年 12 月 | [[!DNL AEP] - [!DNL TARGET] 受众 - 在 [!DNL AEP] 中单次激活后，所有 [!DNL Target] 受众的修改日期都发生变化](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23223.html?lang=zh-Hans) | 新文章 | 了解为什么您可能会看到在 [!DNL Adobe Experience Platform] 中将单个区段激活到您的 [!DNL Target] 目标后，该目标中所有激活的区段的修改日期都发生变化（在 [!DNL Target UI] 内）。 |
| 2023 年 12 月 | [[!DNL AEP] - 当源架构不符合 [!DNL XDM] 时，流式处理轮廓更新失败](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23026.html?lang=zh-Hans) | 新文章 | 了解在流式处理轮廓“[!DNL upsert]”时，如果源架构不符合 [!DNL XDM]，则数据流失败。 |
| 2023 年 12 月 | [[!DNL AEP] - 许可证用量部分中可找到的受众与主页上的轮廓数不同](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23025.html?lang=zh-Hans) | 新文章 | 了解许可证用量部分中可找到的受众何时与主页上的轮廓数不同。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| ----------| ---------- | ---------- |---------- |
| 2023 年 12 月 | [将示例数据导入到 Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=zh-Hans) | 更新的文章 | 了解如何使用示例数据设置 Experience Platform 沙盒环境。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2024 年 1 月 | [在 [!UICONTROL Analysis Workspace] 中共享只读项目](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace.html?lang=zh-Hans) | 视频 | 了解如何与用户共享只读 [!UICONTROL Workspace] 项目，并了解对此权限级别可用的功能。 |
| 2023 年 12 月 | [用于审核数据词典的有用清单](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary.html?lang=zh-Hans) | 文章 | 用我们的 Adobe [!DNL Analytics] 和 [!DNL Customer Journey Analytics] [!UICONTROL 数据词典]审核清单提高数据效率和可靠性。 |
| 2023 年 12 月 | [转化变量简介 (eVar)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-conversion-variables-evars.html?lang=zh-Hans) | 视频 | 了解如何在 Adobe [!DNL Analytics] 中使用转化变量（也称为 eVar），包括它们与转化事件有何关联和它们与流量变量有何区别。 |
| 2023 年 12 月 | [Experience Platform Tags 中 Analytics 扩展的基本配置](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.html?lang=zh-Hans) | 视频 | 观看如何为基本站点配置 [!DNL Experience Platform] Tags 中的 [!DNL Analytics] 扩展。 |
| 2023 年 12 月 | [为 Adobe Tags 中的 Analytics 扩展配置库管理](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/configuring-library-management-in-the-launch-analytics-extension.html?lang=zh-Hans) | 视频 | 了解 Experience Platform Tags 中的 [!DNL Analytics] 扩展的库管理配置选项，包括选择用于数据收集的报告包。 |
| 2023 年 12 月 | [为 Experience Platform Tags 中的 Analytics 扩展配置全局变量设置](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/configuring-global-variables-in-the-launch-analytics-extension.html?lang=zh-Hans) | 视频 | 了解如何为基本网站配置 Analytics Tags 扩展中的全局变量设置。 |
| 2023 年 12 月 | [为 Experience Platform Tags 中的 Analytics 扩展配置常规设置](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.html?lang=zh-Hans) | 视频 | 了解 Experience Platform Tags 中的 Analytics 扩展的常规配置选项，包括设置跟踪服务器。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|----|----|-----------|
| 2023 年 12 月 | [重复的购买 ID 导致在 [!DNL Adobe Analytics] 中不报告](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23145.html?lang=zh-Hans) | 新文章 | 探索重复的购买 ID 如何影响 [!DNL Adobe Analytics]，并阻止订单报告。了解正确的实施如何解决此跟踪问题。 |
| 2023 年 12 月 | [如何手动在 [!DNL Workspace] 报告中排列[!UICONTROL 日期范围维度]顺序？](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21923.html?lang=zh-Hans) | 新文章 | 了解如何解决[!UICONTROL 日期范围]排序图标无法帮助在 [!DNL Adobe Analytics] 中排列[!UICONTROL 维度]顺序的问题。 |
...
* 通过 [Cloud Manager 自定义权限](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions.html?lang=zh-Hans)，可创建自定义权限轮廓，其中具有可配置的权限以限制 [!DNL Cloud Manager] 用户访问项目、管道和环境。
...
| 2023 年 12 月 | [用 [!DNL OOTB] 工作流管理移动应用程序认证到期通知](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23280.html?lang=zh-Hans) | 新文章 | 探索 Adobe Campaign Standard 如何利用其 [!DNL OOTB] 工作流使移动应用程序证书提醒自动化。 |
...
| 2023 年 12 月 | [ACC：MKT（营销）服务器中未收到推送通知令牌](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23273.html?lang=zh-Hans) | 新文章 | 了解在发生其中 MKT（营销）服务器中未收到推送通知令牌的 Adobe Campaign Classic 问题时的解决方案。 |
| 2023 年 12 月 | [ACS：无法使用文件传输活动连接到 Adobe [!DNL SFTP] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23272.html?lang=zh-Hans) | 新文章 | 了解在 Adobe Campaign Standard 中当您发现在使用文件传输/下载活动时无法连接到 Adobe [!DNL SFTP] 的问题的解决方案。 |
...
| 2023 年 12 月 | [特定于机器的登录错误： [!DNL XTK-170092] 查询条件的表达式太复杂。](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23188.html?lang=zh-Hans) | 新文章 | 了解如何执行硬性缓存清除以解决特定于机器的登录错误：XTK-170092 查询条件的表达式太复杂。 |
...
| 2023 年 12 月 | [对于为营销活动配置多个工作流的限制](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23013.html?lang=zh-Hans) | 新文章 | 了解在营销活动中出错的原因以及将“[!UICONTROL 自然属性]”调整为&#x200B;*[!UICONTROL 未指定]*&#x200B;如何可有效地解决问题。 |
| 2023 年 12 月 | [[!DNL X-Env-sender] 与发件人域不同](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23053.html?lang=zh-Hans) | 新文章 | 从这个详细指南了解如何通过检查通往正确外部帐户的路由而修复当 [!DNL X-Env-sender] 与发件人域不同时产生的问题。 |
| 2023 年 12 月 | [客户无法从自定义架构中删除记录](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23001.html?lang=zh-Hans) | 新文章 | 了解如何解决在自定义架构中删除数据的问题。 |
| 2023 年 12 月 | [未处理管道触发器](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23014.html?lang=zh-Hans) | 新文章 | 了解通过在相关实例的每个容器上运行命令而解决未处理管道触发器的问题的快速解决方案。 |
...
| 2023 年 12 月 | [发送电子邮件送达/校样时出错](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22995.html?lang=zh-Hans) | 新文章 | 了解快速指南以修复在使用部署向导发送电子邮件送达/校样时出错的问题。 |
