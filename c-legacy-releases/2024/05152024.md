...
| 功能 | 描述 |
| ------- | ------- |
| 订阅帮助页面 | <ul><li>专门的帮助页面可以用来指导新订阅者设置其主动通知轮廓和偏好设置。</li><li>Adobe 状态概览页面 > 帮助菜单有一个指向这个新页面的新菜单项（[!UICONTROL 如何订阅]）。</li><li>所有引用 [!DNL Adobe Status] 订阅的 Adobe 界面现在都指向新的帮助页面。</li></ul> |
