...
| 2024 年 2 月 | [创建针对特殊页面的 Experience Platform 标记规则](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-special-pages.html?lang=zh-Hans) | 视频 | 除了在每个页面上收集的数据之外，您还具有必须在特定页面上收集的其他数据。 本视频说明如何将该数据与通用数据合并，并将其发送到Adobe Analytics。 |
