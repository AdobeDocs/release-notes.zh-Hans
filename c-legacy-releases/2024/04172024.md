...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|----|----|-----------|
| 2024 年 3 月 | [故障排除 `TargetData` 展示 [!DNL Campaign] 直接邮寄递送中的自定义目标映射问题](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-23799) | 新文章 | 了解如何通过将自定义目标映射与 [!DNL Campaign]的广泛日志架构。 |
