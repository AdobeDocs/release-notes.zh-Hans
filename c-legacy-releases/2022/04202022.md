...
* **Cloud Manager**
   ...
   * 管道向导在配置与它关联的 [Web 层配置管道](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#web-tier-config-pipelines)之前可能需要进行 Experience Manager 环境更新时通知用户。
