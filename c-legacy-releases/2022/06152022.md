...
* **Experience Manager Assets as a Cloud Service**
   ...
   * Experience Manager Assets 使用 Adobe Sensei AI 功能现在[区分图像中的颜色，并在摄取时自动将差异应用为标记](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html?lang=zh-Hans)。这些标记可根据图像颜色组合增强搜索体验。您可以在 1 到 40 的范围内配置已标记图像的颜色数量，以便您以后可以根据这些颜色搜索图像。
