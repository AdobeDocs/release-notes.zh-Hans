...
| [!DNL Inventory Inspector] | （6 月 29 日发布）投放位置[!UICONTROL 检查器]的[!UICONTROL 库存]选项卡现在包括可自定义的数据可视化图表和扩展的性能指标，例如[!UICONTROL 可视性比率]、[!UICONTROL 点击次数]和[!UICONTROL 昨天的 CPM]。 |
