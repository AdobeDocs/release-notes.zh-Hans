...
| 2022 年 1 月 | [“媒体播放耗时”面板](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html) | 视频 | 了解“媒体播放耗时”面板如何使媒体用户能够通过一天中所选粒度的观看时间量来了解他们的收视率。 |
...
| 2022 年 1 月 | [在 Analysis Workspace 中将区段用作维度](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html) | 更新的视频 | 了解如何通过在 Analysis Workspace 中将区段用作维度来比较和可视化区段。 |
| 2022 年 1 月 | [Adobe Analytics 中的区段管理和共享](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-management-and-sharing.html) | 更新的视频 | 在这个更新的视频中，了解一些分享和管理区段的技巧。 |
...
| 2022 年 1 月 | [Analysis Workspace 中的区段比较](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-comparison-in-analysis-workspace.html) | 更新的视频 | 了解区段 IQ（Adobe Analytics 中的 Analysis Workspace 的一部分）如何通过检查所有维度和量度上的任意两个 Analytics 区段来自动发现它们在统计上最显著的差异，从而简化分析。 |
...
* [Customer Journey Analytics 产品文档](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **Forms Portal**：您可以使用 [Forms Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-an-adaptive-form/configure-forms-portal.html) 在 Experience Manager Sites 页面上列出发布的自适应表单。它可以帮助网站访客发现所有可用表单。此外，访客可以使用 [!UICONTROL Forms Portal] 保存和访问自适应表单的草稿，并查看提交的自适应表单的 PDF 版本。
...
| 2022 年 1 月 | [Workfront 增强型连接器基础知识](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/basics.html) | 视频 | 了解 Adobe Workfront 和 Experience Manager Assets 增强型连接器的基础知识。还可以了解 [Project 文件夹](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/project-folders.html)。 | AEM Assets Service 和 Workfront |
| 2022 年 1 月 | [AEM Sites 快速入门 - 快速网站创建](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/site-template/overview.html) | 视频（多个） | 了解如何使用低代码方法通过快速网站创建和预定义网站模板在 Adobe Experience Manager 中创建您的第一个网站。 | AEM Sites |
| 2022 年 1 月 | [非标准端口上的 HTTP/HTTPS 连接，实现灵活端口出口](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/http-on-non-standard-ports-flexible-port-egress.html) | 视频（多个） | 了解如何将非标准端口（非 80/443）上的 HTTP/HTTPS 连接代理出 AEM as a Cloud Service。 | AEM as a Cloud Service |
...
| 2022 年 1 月 | [AEM Commerce as a Cloud Service 快速入门](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/storefront/getting-started.html) | 视频 | 了解营销人员如何使用 Adobe Experience Manager 中的相关内容扩充产品数据。AEM 中的资产、体验片段和内容片段等内容可以与商业产品相关联。 | AEM as a Cloud Service |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 1 月 | [XML 文档发布](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/release-info/latest-release-info.html) | 视频 | 了解 Experience Manager Guides 这款强大的企业级组件内容管理解决方案 (CCMS)。该解决方案在 Adobe Experience Manager 中启用原生 DITA 支持，使 AEM 能够处理基于 DITA 的内容创建和交付。 |
| 2022 年 1 月 | [使用 AEM 的 XML 文档生成输出](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/output-generation/overview.html) | 视频和文章 | 了解地图仪表板、报表、带有基线和条件的发布等内容。 |
...
| 2022 年 1 月 | [设置投放模板属性](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/using-delivery-templates/set-delivery-template-properties.html) | 视频 | 了解如何设置投放模板属性并详细说明每个属性。 | Campaign v8 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 1 月 | [增强 PDF](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/enhance.html) | 视频 | 在这个实践教程中，学习如何通过添加图形增强功能和自动编号来转换您的 PDF。 |
