...
[Experience League LIVE](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) 是 Experience League 团队制作的直播节目。这是结交 Adobe 产品专家的大好机会。了解可通过 Adobe Experience Cloud 应用程序应用的可行性提示、技巧和策略。
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **使用Communications API创建的记录文档和PDF文档的自定义字体**：您现在可以在使用Communications API生成的PDF文档中使用品牌批准的字体，以满足您的组织要求。
