...
| 功能 | 描述 |
| ------- | ----------- |
| [!UICONTROL 自定义报表] | (5月31日；测试版功能)Advertising Cloud DSP现在可以摄取由在客户数据平台(CDP)中构建的经过验证的信号组成的第一方区段。 |
| 优化目标 | （5月25日）现在，带有自定义目标的包中可以包含视频和本机版面 [!UICONTROL 最高ROAS] 和 [!UICONTROL 最低CPA]. |
...
| 与 Adobe Analytics 集成 | （5月7日）在Advertising Cloud发送至 [!DNL Analytics]，数据 [!DNL Google Ads] 动态搜索广告仅可从2022年5月7日开始精确到广告组级别。 |
