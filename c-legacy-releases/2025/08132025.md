...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|--------|---------|---------|
| 2025 年 8 月 | [[!DNL Quality Patches Tool] （QPT）](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/patches-available-in-qpt-tool-overview) | 新文章 | 关于如何应用 QPT 1.1.67、QPT 1.1.68 和 QPT 1.1.69 中补丁的新文章已发布，并可在相应的章节中找到。 |
...
| 2025 年 8 月 | Commerce Cloud 上因 PHP 内存耗尽导致 [`setup:upgrade` 失败](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-27387) | 新文章 | 了解在 Adobe Commerce 云基础架构的[!UICONTROL 生产]环境重新部署期间，因 PHP CLI 超过默认 1 GB 内存限制而导致 `setup:upgrade` 命令失败时的解决方案。 |
