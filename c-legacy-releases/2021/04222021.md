...
| 专用内容库 | （10 月 15 日版）如今，所有用户都可以使用新的交易 ID 表单来设置和编辑交易 ID 详细信息，该表单是旧版智能广告投放表单的简化版。要设置新的交易ID详细信息，请转到 **[!UICONTROL 库存]** > **[!UICONTROL 交易]** > **[!UICONTROL 创建]**，然后选择 **[!UICONTROL 交易ID测试版]**. |
