...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 8 月 | [将个人资料和区段激活到目标](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-profiles-and-segments-to-a-destination.html) | 视频 | 了解营销人员可以在 Real-time CDP 中执行哪些步骤来将受众区段激活到目标。了解如何在[!UICONTROL 目标]或[!UICONTROL 区段]界面（采用对您最方便的方式）中启动此工作流。 |
...
| 功能 | 描述 |
| ------- | ----------- |
| 投放位置的[!UICONTROL 预竞价可视性] | 来自 Oracle Advertising (Moat) 的[!UICONTROL 预竞价可视性]过滤器现在可用于投放位置。 |
