...
| 2021 年 8 月 | [用例展示](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/use-case/use-case-showcase.html?lang=zh-Hans) | 录制的会议 | 用例展示是一个直播会议，向您介绍新的 Adobe Sign 用例和趋势，并演示您的组织如何实施这些用例并从中受益。每个月都会重点介绍一个新主题。 |
