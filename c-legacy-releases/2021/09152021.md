...
需要帮助？请访问 [Experience League](https://experienceleague.adobe.com/#home)，查找产品和技术文档、Adobe 策划课程、视频教程、快速解答、社区洞察以及由讲师指导的培训。
...
| 2021 年 8 月 26 日 | [更智能地确定下一个受众区段](https://experienceleague.adobe.com/docs/experience-league-live-events/events/episodes/exl-live-episode-02.html) | 录制的活动 | 每一个好的营销活动的成功都离不开准确定位受众。利用新的 Adobe Experience Platform [!UICONTROL 区段生成器]，您可以使用各个渠道的个人资料数据和基于时间的用户行为来构建下一个受众区段。要确保您的信息传达给最需要听到的人，没有比这更好的方法了。 |
...
| 2021 年 9 月 | [如何对查看用户个人资料时出现的技术错误进行故障排除](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/technical-error-while-viewing-profile.html) | Campaign Standard | 了解如何修复在控制台登录时遇到的错误。 |
...
| 营销活动管理视图 | “[!UICONTROL 创建日期]”列现在包含在[!UICONTROL 营销活动]、[!UICONTROL 包]、[!UICONTROL 投放位置]和[!UICONTROL 广告]视图中的自定义列组中。您现在还可以按[!UICONTROL 创建日期]筛选[!UICONTROL 投放位置]和[!UICONTROL 广告]视图。 |
| 计划性保证交易 | （9 月 8 日版）您现在可以编辑计划性保证 (PG) 交易的默认投放位置的[!UICONTROL 最高出价]。不过，由于 PG 交易始终具有固定 CPM，因此，仅国际客户需编辑[!UICONTROL 最高出价]以考虑货币兑换费。 |
|  | （9 月 8 日版）具有“[!DNL FreeWheel Programmatic Guaranteed]”权限的用户现在可以从[!UICONTROL 广告]视图或[!UICONTROL 投放位置]视图将广告提交到 [!DNL FreeWheel Programmatic Creative API]。您仍可以从[!UICONTROL 交易]视图提交广告。 |
