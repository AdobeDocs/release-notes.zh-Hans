...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
      ...
      * **Web 编辑器的新外观** - UI 发生了变化的新外观，这些变化使 UI 更加直观。底层架构已从珊瑚色更改为基于反应的图谱。
      ...
      有关详细信息，请访问 [Experience Manager Guides](https://www.adobe.com/cn/products/xml-documentation-for-experience-manager.html)。
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [Experience Manager Guides](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/overview.html?lang=zh-Hans) | 文章 | 了解 [!UICONTROL XML 文档解决方案]如何提供所有核心 CCMS 功能，例如 DITA 内容的协作、审阅、翻译、搜索和报告。利用这些功能，作者能够通过高效的内容重用和功能强大的工作流在更短的时间内完成更多工作。 |
...
| 2021 年 7 月 | [使用 Adobe Document Services API 创建和编辑报告](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/reportcreation.html?lang=zh-Hans) | 文章 | 利用 PDF，可以轻松地以每个人都可以查看的格式共享包含表格、图形和交互式内容的丰富文档。了解如何与他们的高管、利益相关者、捐助者或其他利益相关者共享这些统计数据。 |
