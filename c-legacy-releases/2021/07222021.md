...
| 2021 年 7 月 | [使用 Adobe Document Services API 进行搜索和索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html) | 文章 | 本教程探索AdobeDocument Services API的出色功能，以及如何轻松使用它们来存档和数字化文档。 我们通过构建 Express NodeJS 应用程序，然后集成用于存档、数字化和文档转换的 Document Services API 来探索这些功能。 |
...
| 2021 年 7 月 | [使用 Adobe Document Services API 创建 NDA](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html) | 文章 | 了解如何为您的公司 NDA 创建 Microsoft® Word 模板。Adobe适用于Microsoft®Word的AdobeDocument Generation Tagger的免费加载项可帮助您插入“标记”以输入动态值。 您还将了解如何将 JSON 数据传递给模板和创建动态 PDF。然后，您可以通过电子邮件发送该 PDF，或在协作者的浏览器中向协作者显示该 PDF，具体取决于您的业务需求和目标。 |
