...
[文档](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html?lang=en) - [发行说明](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=zh-Hans) - [操作方法视频](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/introduction-to-decision-management.html?lang=en)
...
* **Experience Manager as a Cloud Service**
   ...
   * **AEM as a Cloud Service 中的 Cloud Manager**
      ...
      * 添加了新代码质量规则来验证 `damAssetLucene` 索引的结构。请参阅[自定义 DAM 资源 Lucene Oak 索引](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html?lang=en)。
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [Experience Manager Guides](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/overview.html?lang=en) | 文章 | 了解 [!UICONTROL XML 文档解决方案]如何提供所有核心 CCMS 功能，例如 DITA 内容的协作、审阅、翻译、搜索和报告。利用这些功能，作者能够通过高效的内容重用和功能强大的工作流在更短的时间内完成更多工作。 |
...
* [Campaign v8 发行说明](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html?lang=en)
...
* Adobe Campaign v8：[帮助中心](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html) - [发行说明](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html?lang=zh-Hans) - [《实施指南》](https://experienceleague.adobe.com/docs/campaign/campaign-v8/config/implement/implement.html?lang=en)
...
| 2021 年 7 月 | [使用 Adobe Document Services API 发布作业](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html?lang=en) | 文章 | 在运营具有多个用户的网站时，设计一种体验来确保每个人都能获得流畅的体验至关重要。 了解如何将所有上传的文档自动转换为 PDF 并将它们嵌入到发布中。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 创建和编辑报告](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html?lang=en) | 文章 | 利用 PDF，可以轻松地以每个人都可以查看的格式共享包含表格、图形和交互式内容的丰富文档。了解如何与他们的高管、利益相关者、捐助者或其他利益相关者共享这些统计数据。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 进行审阅和批准](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html?lang=en) | 文章 | 了解如何使用多个 Adobe Document Services API 解决实践审阅和批准用例。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 进行搜索和索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=en) | 文章 | 本教程探索AdobeDocument Services API的绝佳功能以及如何轻松地使用它们来存档和数字化文档。 我们通过构建 Express NodeJS 应用程序，然后集成用于存档、数字化和文档转换的 Document Services API 来探索这些功能。 |
...
| 2021 年 7 月 | [使用 Adobe Document Generation API 处理发票](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html?lang=en) | 文章 | 了解如何使用 Adobe Document Generation API 自动生成发票、通过密码保护 PDF 以及向每位客户提供发票。您只需要一点 Node.js、JavaScript、Express.js、HTML 和 CSS 的知识。 |
