...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [使用 XDM 对您的客户体验数据进行建模](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-D-1-2021.1.xdm) | 课程 | 了解如何在 Adobe Experience Platform 中构建数据模型。本课程向您介绍体验数据模型 (XDM) 以及如何将现有数据模型转换为 XDM。了解如何使用标准类和字段组构建架构并构建您自己的自定义组件。 |
| 2021 年 7 月 | [数据工程师查询服务快速入门](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-D-1-2021.1.qsvc.gsde) | 课程 | 了解如何验证提取的数据、从存储在数据湖中的数据获得洞察，以及如何准备数据以使用查询服务做出业务关键决策。 |
| 2021 年 7 月 | [使用查询服务创建仪表板](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-D-1-2021.1.qsvc.dash) | 课程 | 了解如何验证提取的数据、从存储在数据湖中的数据获得洞察，以及在 Adobe Experience Platform 中使用查询服务创建仪表板。 |
| 2021 年 7 月 | [营销人员 Real-time CDP 快速入门](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-U-1-2021.1.rtcdp) | 课程 | 在本课程中，您可以了解作为商业实践者开始使用 Real-time Customer Data Platform (Real-time CDP) 所需的一切。 |
| 2021 年 7 月 | [数据科学家的 Data Science Workspace 快速入门](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-U-1-2021.1.dsw) | 课程 | 了解 Adobe Experience Platform 中的 Data Science Workspace。本课程专为数据科学家而设计，这些数据科学家想要学习如何使用 [!DNL JupyterLab] 笔记本获取洞察和查询数据、创建支持轮廓的数据集、发布自动化机器学习模型，以及对 Adobe 和非 Adobe 应用程序激活机器学习洞察。 |
| 2021 年 7 月 | [Adobe Experience Platform 数据管理快速入门](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-D-1-2021.1.dgov.gs) | 课程 | 了解如何控制您的数据，包括在数据源中收集数据的那一刻以及将数据同时发布到Adobe Experience Platform之外的目标那一刻。 |
...
请参阅 [Offer Decisioning 发行说明](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=zh-Hans)以及时了解最新信息。
...
| 功能 | 描述 | [正式发布](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html?lang=zh-Hans) - 目标日期 |
| ----------- | ---------- | ------- |
...
| 注意事项 | 添加或更新日期 | 描述 |
| ----------- | ---------- | ---------- |
| Adobe Data Connectors 生命周期终止 | 2021 年 8 月 3 日 | Adobe [!UICONTROL 数据连接器]由传统技术提供支持，而这些技术不再可行或不再受支持。可使用该标准继续提供和支持任何集成。正式的生命周期结束日期为 **2021 年 8 月 19 日**。[了解详情...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=zh-Hans) |
...
| 2021 年 7 月 | [条形图和堆叠条形图可视化图表](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bar-and-bar-stacked-visualizations.html?lang=zh-Hans) | 视频 | 在本视频中，我们将讨论在 Analysis Workspace 内的项目中添加和配置条形图、堆叠条形图、水平条形图和水平条形图堆叠可视化图表。虽然这些可视化图表被认为是基本可视化图表，但它们可以帮助您讲述数据故事并为您的分析师提供洞察。 |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
     ...
     有关详细信息，请访问 [Experience Manager Guides](https://business.adobe.com/cn/products/experience-manager/guides/aem-guides.html)。

   * **AEM as a Cloud Service 中的 Cloud Manager**

      * [!UICONTROL 预览服务]以滚动方式部署到了所有程序。为[!UICONTROL 预览服务]启用了客户的程序后，会在产品中通知客户。请参阅[访问预览服务](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html?lang=zh-Hans)。
      ...
      * 添加了新代码质量规则来验证 `damAssetLucene` 索引的结构。请参阅[自定义 DAM 资源 Lucene Oak 索引](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html?lang=zh-Hans)。
      * “环境详细信息”页面现在会酌情显示发布和预览服务的多个域名。请参阅[环境详细信息](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html?lang=zh-Hans)。

   * **Experience Manager Assets as a Cloud Service**

     Assets 中的新增功能：

      * 利用[!UICONTROL 内容自动化]功能，Experience Manager Assets 可以使用 Adobe Creative Cloud API 大规模自动进行资源生产。它通过显著减少创建同一资源的变体所需的时间和反复操作来提高内容速率。该功能不需要进行任何编程，并且可在 DAM 内使用。请参阅[使用 Adobe Creative Cloud 集成生成资源变体](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/cc-api-integration.html?lang=zh-Hans)。
      ...
      * 在批量提取期间，可使用[资源批量提取器工具](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html?lang=zh-Hans)添加元数据。

     Assets 预发行渠道中的新功能：

      * 为了让您可以选择默认视图和默认排序参数，增强了视图设置。
      * [!UICONTROL 链接共享]下载功能使用可提高下载速度的异步下载。请参阅[下载使用链接共享功能共享的资源](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/download-assets-from-aem.html?lang=zh-Hans)。
      * 您可以根据属性谓词搜索和筛选文件夹。
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [Experience Manager Guides](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/overview.html?lang=zh-Hans) | 文章 | 了解 [!UICONTROL XML 文档解决方案]如何提供所有核心 CCMS 功能，例如 DITA 内容的协作、审阅、翻译、搜索和报告。利用这些功能，作者能够通过高效的内容重用和功能强大的工作流在更短的时间内完成更多工作。 |
...
| 发布日期 | 名称 | 解决方案 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [通过组合查询结果来优化目标](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/targeting-workflows/refine-targets-by-combining-query-results.html?lang=zh-Hans) | Campaign v8 | 了解如何在工作流程中通过使用交集或并集活动来组合查询结果，进而优化目标。 |
...
| 2021 年 7 月 | [使用 Adobe PDF Embed API 发布数字文档](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/ddppdfembedapi.html?lang=zh-Hans) | 文章 | 通过在您的网页中嵌入 PDF 查看器，您可以使用户能够查看文档，而无需重新设计您的 HTML 和 CSS，也不会阻止访问您的网站。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 进行师生协作](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/educationcollab.html?lang=zh-Hans) | 文章 | 了解供 `Node.js` 应用程序访问 PDF Services API 的官方 SDK。这使您能够将 Microsoft® Word 或 Microsoft® Excel 等文档转换为 PDF。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 发布作业](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html?lang=zh-Hans) | 文章 | 在运营具有多个用户的网站时，设计一种体验来确保每个人都能获得流畅的体验至关重要。 了解如何将所有上传的文档自动转换为 PDF 并将它们嵌入到发布中。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 创建和编辑报告](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html?lang=zh-Hans) | 文章 | 利用 PDF，可以轻松地以每个人都可以查看的格式共享包含表格、图形和交互式内容的丰富文档。了解如何与他们的高管、利益相关者、捐助者或其他利益相关者共享这些统计数据。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 进行审阅和批准](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html?lang=zh-Hans) | 文章 | 了解如何使用多个 Adobe Document Services API 解决实践审阅和批准用例。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 进行搜索和索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=zh-Hans) | 文章 | 本教程探索Adobe Document Services API的出色功能，以及如何轻松使用它们来存档和数字化文档。 我们通过构建 Express NodeJS 应用程序，然后集成用于存档、数字化和文档转换的 Document Services API 来探索这些功能。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理员工录用通知书](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/offer.html?lang=zh-Hans) | 文章 | 本教程逐步介绍如何设置 Node Express 项目，该项目将显示一个 Web 表单供用户填充员工详细信息。这些详细信息在 Web 上使用文档服务生成 PDF 形式的录用通知书，此通知书以后可以交付给客户以供他们使用 Adobe Sign API 进行签名。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理法律合同](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/legal.html?lang=zh-Hans) | 文章 | 在本教程中，我们将在文档内生成自定义输入字段过程中探索 Adobe Document Services API 的功能。我们还探索如何轻松地将这些生成的文档转换为受保护的便携式文档格式 (PDF) 以防止数据处理。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 创建 NDA](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html?lang=zh-Hans) | 文章 | 了解如何为您的公司 NDA 创建 Microsoft® Word 模板。Adobe适用于Microsoft®Word和Adobe Document Generation Tagger的免费加载项可帮助您插入“标记”以输入动态值。 您还将了解如何将 JSON 数据传递给模板和创建动态 PDF。然后，您可以通过电子邮件发送该 PDF，或在协作者的浏览器中向协作者显示该 PDF，具体取决于您的业务需求和目标。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理销售提案和合同](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/sales.html?lang=zh-Hans) | 文章 | 了解如何使用动态数据和工作流来构建高效的销售提案创建流程。 |
| 2021 年 7 月 | [使用 Adobe Document Generation API 处理发票](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html?lang=zh-Hans) | 文章 | 了解如何使用 Adobe Document Generation API 自动生成发票、通过密码保护 PDF 以及向每位客户提供发票。您只需要一点 Node.js、JavaScript、Express.js、HTML 和 CSS 的知识。 |
