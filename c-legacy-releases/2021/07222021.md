...
| 2021 年 7 月 | [使用 Adobe Document Services API 进行搜索和索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=zh-Hans) | 文章 | 本教程探索AdobeDocument Services API的出色功能，以及如何轻松使用它们来存档和数字化文档。 我们通过构建 Express NodeJS 应用程序，然后集成用于存档、数字化和文档转换的 Document Services API 来探索这些功能。 |
