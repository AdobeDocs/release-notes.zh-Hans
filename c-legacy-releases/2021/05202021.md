...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 5 月 | [设置内部 URL 筛选器](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=zh-Hans) | 视频 | 了解[!UICONTROL 反向链接] URL 的设置，可将其设置为内部反向链接（以编制路径报告）或外部反向链接（以编制反向链接/反向链接域报告）。 |
...
有关最新的发布计划信息，请参阅 [!DNL Marketo Engage] [发行说明](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html)。
