...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service 基础**
      ...
      * [API 弃用](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/deprecated-apis.html)：最新的弃用 API 的列表。
...
* **新的 Adobe Campaign v8** 在基础架构、安全性、可投放性和监测方面有着显著改进。Adobe Campaign v8 大幅提升了其规模和速度，能够管理更多的客户档案，并且可实现更高的投放率和每小时事务处理量。请参阅 [Campaign v8 文档](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=zh-Hans)以了解详情。
