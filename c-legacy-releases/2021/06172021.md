...
| 2021 年 6 月 | [查询服务概述](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/understanding-query-service.html?lang=zh-CN) | 视频 | 了解 Adobe Experience Platform 中的查询服务以及该服务如何帮助了解客户行为并生成有效洞察。 |
...
Experience Manager (AEM) 中的新增功能、修复和更新。Adobe 推荐采用内部部署的客户部署最新的修补程序以确保稳定性、安全性和性能得到提高。
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service 基础**
      ...
      * [预发行渠道](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/prerelease.html)：在即将发布的功能发布至生产环境前的一个月进行预览！
...
| [!UICONTROL 广告洞察] | Beta 模式中提供了以下洞察：<ul><li>[!UICONTROL 规范化 Sim（组合）Beta]</li><li>[!UICONTROL 项目组合发布 Beta]</li> |
