...
请参阅 [Experience Cloud 服务的发行说明汇总](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html?lang=en)，以了解最新发行信息。
...
请参阅 [AEM as a Cloud Service 发行说明](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en)。
...
| 2020 年 11 月 14 日 | [为 Advertising 激活和报告创建 Analytics 配置文件](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-profiles-a4adc.html?lang=zh-Hans#analytics) | 视频 | 如何使用 Adobe Analytics 为 Advertising 再营销创建稳固的站点重定向池。 |
