...
| 2021 年 10 月 | [面向新发送者的 Adobe Sign 快速入门](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/new-sender.html) | 视频 | 如果您是初次使用Adobe Sign，则本教程是一个很好的起点。 本全面教程包含所有基础知识，可帮助您快速开始使用 Adobe Sign。 |
