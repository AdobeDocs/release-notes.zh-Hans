...
| Experience Cloud [!UICONTROL 触发器]导航 | [Experience Cloud 触发器](https://experienceleague.adobe.com/docs/core-services/interface/services/triggers.html)适用于从已设置用户标头中的应用程序切换器的直接导航。 |
