...
| 内容 | 描述 |
| -----------| ---------- |  
| [配置文件替换 - 使用目标配置文件测试电子邮件](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/email/profile-substitution.html?lang=zh-Hans) | 使用“配置文件替换”功能测试电子邮件。 |
