...
| [Analysis Workspace 中的多个报表包](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/multiple-report-suites-in-analysis-workspace.html?lang=en) | 通过在面板级别选择报表包，可以在一个[!UICONTROL 工作区]项目中分析多个报表包。这样，您就可以跨不同的数据集进行并排面板分析。 |
