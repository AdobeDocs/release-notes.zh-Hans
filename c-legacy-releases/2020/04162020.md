...
* [[!DNL Campaign]](#ac)
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html)（链接到 Target 帮助页面）
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
| 内容 | 描述 |
| -----------| ---------- |  
| [配置文件替换 - 使用目标配置文件测试电子邮件](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/email/profile-substitution.html) | 使用“配置文件替换”功能测试电子邮件。 |
