...
* **[!UICONTROL Analysis Workspace]** 中的多个报告包：您现在可以将多个报告包中的数据并入一个 [!UICONTROL Analysis Workspace] 项目，以便在并排面板中查看。[了解更多...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.html?lang=en)
...
* 修复了在分类维度报告中将“进入”或“退出”量度应用于“未指定”时，有时会造成计数错误的问题。
...
* 修复了由于缺少 RBAC 权限 [!UICONTROL VIEW_ALL_DESTINATIONS]，客户无法更新区段名称的错误。更新区段时，不应当要求 [!UICONTROL VIEW_ALL_DESTINATIONS] 权限。有关 RBAC 权限的更多信息，请参阅[管理（RBAC 控制）](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html?lang=en)。(AAM-52760)
...
* **AEM Assets Brand Portal**
   ...
   * [发行说明](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html?lang=en)
...
有关更多信息，请参阅 [!DNL Marketo] [2020 年 2 月版](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=en)发行说明
...
| [!DNL Adobe Campaign] | 教程 - [使用 Android™ 推送通知](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | 向 iOS 和 Android™ 移动设备发送个性化的分段推送通知。本教程将向您介绍从 Adobe Campaign 发送推送通知以及在 Android™ 应用程序中接收这些通知所涉及的步骤。 |
| [!DNL Adobe Campaign] | 视频 - [创建推送通知](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/mobile/push/creating-a-push-notification.html?lang=en) | 在 Adobe Campaign Standard 中创建推送通知。您可以向 iOS 和 Android™ 移动设备发送个性化的分段推送通知。 |
...
| Adobe Analytics | 视频 - [Adobe Analysis Workspace 怎样可以改变您的业务方式](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.html?lang=en) | 了解如何使用 [!UICONTROL Analysis Workspace] 来执行 Ad Hoc Analysis、灵活分析、队列分析和流失分析。您还可以与公司中的每位人员共享分析工作环境，其拖放功能使每个人都能轻松分析数据并快速获得洞察。 |
