...
**注意：** 的 [!UICONTROL 信息源] 页面已于2020年1月被弃用。 请查看产品内的弃用通知。
...
* [Experience Platform 发行说明](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=en)
...
| [!DNL Adobe Campaign] | 教程 - [向 Android 设备发送推送通知™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=zh-Hans) | 向iOS和Android™移动设备发送个性化的分段推送通知。 本教程将向您介绍从 Adobe Campaign 发送推送通知以及在 Android™ 应用程序中接收这些通知所涉及的步骤。 |
...
| Adobe Analytics | 视频 - [Adobe Analysis Workspace 怎样可以改变您的业务方式](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.html?lang=en) | 了解如何使用执行Ad Hoc Analysis、灵活分析、同类群组分析和流失分析 [!UICONTROL Analysis Workspace]. 您还可以与公司中的每位人员共享分析工作环境，其拖放功能使每个人都能轻松分析数据并快速获得洞察。 |
