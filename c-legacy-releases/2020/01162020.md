...
有关产品文档，请参阅 [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html)。
...
Journey Orchestration 现已正式推出。[了解更多信息](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html)
...
| **[!UICONTROL 强制 IP 登录限制]**&#x200B;选项生命周期终止 | 2019 年 10 月 30 日 | 2020 年 1 月，将结束使用&#x200B;**[!UICONTROL 管理 > 公司设置 > 安全]**&#x200B;菜单下的 IP 允许列表（**[!UICONTROL 强制 IP 登录限制]**）功能。 |
...
请参阅 [AppMeasurement for Javascript 发行说明](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html)。
...
* **AEM 桌面应用程序 2.0.1.1**
   ...
   * [发行说明](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html)
...
* **新增功能：AEM as a Cloud Service**
   ...
   * [简介](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html)
   * [发行信息](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html)
   * [文档](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html)

* **自动化表单转换服务**

  2019 年 12 月 12 日，正式推出了自动表单转换服务，此项服务可自动将 PDF 表单转换为美观的移动就绪 HTML 表单。

   * [简介](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html)
   * [配置服务](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
...
* **预览 3D 资产**
  ...
  AEM 6.5 支持在创作过程中上传、交付和以交互式方式预览 3D 资产。交互式 3D 查看器可从 AEM 的资产详细信息页面找到。该查看器包括一组交互式相机控件及其他要素，可让您环绕、缩放和平移 3D 资产。请参阅[预览 3D 资产](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html)。

* **核心组件**

  核心组件 2.8.0（包含多项修复）现已与[创作文档](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html)一起提供，另外还可[在 GitHub 上查看开发人员详细说明并下载项目](https://github.com/adobe/aem-core-wcm-components)。

* **AEM 项目原型**

  [AEM 项目原型](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=zh-Hans)的 [ui.frontend 模块](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uifrontend.html)是一个灵活实用的工具，可简化 AEM 项目的前端开发。
...
* 设置新子域 - [阅读更多内容](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)
...
* Adobe Campaign 控制面板：[文档](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html) ‑ [发行说明](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html)
...
| 搜索 > 营销活动、报告 | Google Ads的突出量度“Impr.(Abs. Top) %”和“Impr. (Top) %”，但是，对于那些选购性产品组、“促销活动日市场份额”和“关键词日市场份额”报表，以及标签和限制性视图中，目前均可用于所有基本报表和实体级别的促销活动管理视图。 |
