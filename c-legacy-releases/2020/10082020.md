...
* [Service Pack 6.5.5.0](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/previous-hotfixes-featurepacks.html?lang=zh-Hans#assets-6550) 的桌面应用程序登录问题已在桌面应用程序版本 2.0.3.2 中修复。
...
| 2020 年 9 月 21 日 | [设置Adobe Developer App Builder](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/firefly.html?lang=zh-Hans) | 视频 | asset compute应用程序是特别定义的Adobe Developer App Builder应用程序，因此，需要访问Adobe Developer Console中的Adobe Developer App Builder才能设置和部署这些应用程序。 |
