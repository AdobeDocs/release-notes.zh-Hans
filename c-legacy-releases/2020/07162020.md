...
* 修复了[入站状态报告](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/onboarding-status-report.html)中的以下问题：客户在单击图形中的条柱以及表中的日期时，可能会看到日期不匹配的问题。(AAM-55235)
...
* **AEM 6.5.5 Forms 文档更新**
   ...
   * 6.5.5 版本中的新增功能和改进功能：
      ...
      * [改进了事务报告中的错误日志记录。](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
   * 6.4.8.1 版本中的新增功能和改进功能：
      ...
      * [改进了事务报告中的错误日志记录。](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
...
* 新增 Gold Standard 稳定版本。[了解更多信息](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html#release-19-1-4-build-9032)

#### Campaign 控制面板

* 子域交付性审核 - [了解更多信息](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)
...
| 基于人员的跨设备图形定位 | 自助式 DSP 客户可以利用设备图（Adobe 设备协作或 LiveRamp），在新营销活动中进行基于人员的定位和频率管理。这确保了广告商可以通过其拥有的设备接触到受众，但会限制曝光度。此外，针对多个投放位置，跨设备定位设置的批量编辑功能现在处于 Beta 阶段。 要为您的帐户启用 Beta 版，请联系您的 Adobe 客户经理。 |
| 网站定位 | “阻止列表”和“允许列表”被重命名为更为合理的术语“阻止（站点）”和“目标（站点）”。 |
| Flashtalking 广告 | DSP 现在可通过单个广告创建和批量第三方广告创建工作流程自动为所有 Flashtalking 广告标记插入点击宏。 |
| 报告 | （仅限 Adobe Experience Platform 客户的 Beta 版）Advertising Cloud Search 中的新跨渠道报告提供了跨 DSP 和搜索的媒体支出的统一视图，以及 DSP 投放位置和搜索活动的每日关键量度。 |
