...
| 2020 年 6 月 23 日 | [处理轮廓](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html) | 视频 | 处理轮廓定义了要为 AEM as a Cloud Service 中的资产创建的演绎版内容。 |
...
* 新增 Gold Standard 稳定版本。[了解详情](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html#release-19-1-4-build-9032)
