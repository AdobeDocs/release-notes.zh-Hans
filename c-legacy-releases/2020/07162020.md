...
* [Analytics](#analytics) 和 [Customer Journey Analytics](#cust-journey) （更新日期：2020年7月14日）
...
* 修复了[入站状态报表](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/onboarding-status-report.html?lang=zh-Hans)中的以下问题：客户在单击图形中的条柱以及表中的日期时，可能会看到日期不匹配的问题。(AAM-55235)
