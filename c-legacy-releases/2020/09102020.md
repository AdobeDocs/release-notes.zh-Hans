...
| 2020 年 8 月 17 日 | [Google 目标客户匹配功能](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/integrate-with-google-customer-match.html) | 视频 | 此视频演示了Adobe的Real-Time CDP和Google的“客户匹配”功能如何帮助品牌就Google自有资产和运营资产与其客户进行互动，从而实现增加促销活动推广力度的业务目标。 |
...
| 2020 年 8 月 17 日 | [面向数据架构师的 Adobe Experience Platform 快速入门](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2020.1) | 视频 | 了解数据架构师如何在 Adobe Experience Platform 中完成关键任务。这个入门级课程通过视频和实操练习，引导您开始在 XDM 架构中进行数据建模、标记客户身份标识以便将数据拼合到“实时轮廓”、创建区段等。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 8 月 10 日 | [使用细分资格筛选事件](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/using-segment-qualification-events.html) | 视频 | 此视频简要介绍了如何将[!UICONTROL 细分资格筛选]事件创建为登入点或退出点的过程。 |
...
| 工作区：下载适合单个维度的 50,000 个项目 | 2020 年 9 月 17 日 | 您将能够在自由格式表中下载适合单个维度的 50,000 个项目，并应用区段和过滤器。这允许您访问 Analysis Workspace 以外 400 多行数据。[了解更多...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/download-send.html#download-items) |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 8 月 30 日 | [Analysis Workspace 项目的保存、共享和协作](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/saving-sharing-and-collaborating-on-projects-in-analysis-workspace.html) | 视频 | 在 [!UICONTROL Analysis Workspace] 中，了解如何向表格添加文本说明，如何为项目创建直接链接并共享该链接。 |
| 2020 年 8 月 28 日 | [课程介绍 - 将价值归因于客户历程中的数字接触点](https://video.tv.adobe.com/v/39380) | 视频 | 在这个介绍性的视频中，了解[将价值归因于客户历程中的数字接触点](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2020.2)课程的先决条件和课程内容。 |
| 2020 年 8 月 28 日 | [将价值归因于客户历程中的数字接触点](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2020.2) | 课程 | 通过以下方式，开始认识您的网站访客：了解您的网站对访客有哪些吸引力，了解如何为网站上的不同渠道分配转化积分，甚至要了解网站上的其他项目如何促进转化。本课程将向您讲授显示此分析结果的主要可视化图表，并且还会讲解如何使用[!UICONTROL 归因 IQ] 在分析中分配归因模型。 |
...
| 2020 年 8 月 21 日 | [右键单击以提高工作区效率](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/right-click-for-workspace-efficiency.html) | 视频 | 了解我们喜欢的所有 Analysis Workspace 的右键单击操作及其使用方法。从自由格式表到流失可视化图表，右键单击操作可以让您更高效、更熟练地在工作区中进行操作。 |
...
| 2020 年 8 月 14 日 | [充分利用轮廓合并规则 - 提示、技巧和策略](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/profile-merge/customer-tips-getting-the-most-out-of-profile-merge-rules.html) | 文章 | Varun Kalra 是 [!DNL Accordant] 的多解决方案顾问，在选择和使用[!UICONTROL 轮廓合并规则]方面给予了相关提示。 |
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * 现在，资产微服务可支持视频转码，而且[!UICONTROL 处理轮廓]屏幕中新增的[!UICONTROL 视频]部分可支持配置视频比特率和维度（视频输出格式为带有 H.264 编解码器的 MP4 文件）。详细信息，请参阅[管理视频资产](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/manage-video-assets.html#transcode-video)。要获得更多转码选项和视频分发选项，可使用 [!UICONTROL Dynamic Media] 加载项。
   * 新的资产下载体验支持：
   ...
   * 请参阅 [AEM as a Cloud Service 发行说明](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)。
...
* **[!UICONTROL 表单]**
   ...
   * 提供了更新的 [Gov 和 We.Finance 参考网站演练](https://experienceleague.adobe.com/docs/experience-manager-65/forms/getting-started/aem-forms-reference-collaterals/forms-gov-reference-site-user-demo.html)。您可以利用这些参考网站来了解端对端工作流程，为政府和金融行业创建并提供表单。
...
| 2020 年 8 月 17 日 | [配置对 AEM 演练的访问权限](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/walk-through.html) | 视频 | 在 Adobe [!UICONTROL Admin Console] 中，配置 Adobe IMS 用户、[!UICONTROL 用户组]以及[!UICONTROL 产品轮廓]的简略演练步骤。此外，了解如何利用 [!UICONTROL AEM Author] 中的这些 Adobe IMS 抽象概念，来定义和管理特定的基于组的权限。 |
...
| 2020 年 8 月 17 日 | [创建 Launch 资产](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/configure-launch/launch.html) | 视频 | 了解如何使用设置其余集成所需的最低裸机配置来创建 Launch 属性。向用户介绍 Launch UI，并让用户了解扩展功能、规则和发布工作流程。 |
...
| 2020 年 8 月 17 日 | [Adobe IMS 产品轮廓](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-product-profiles.html) | 视频 | Adobe IMS 产品轮廓授权用户登录 AEM Author 服务，并根据用户所加入的产品轮廓提供访问权限基准。 |
...
| 2020 年 8 月 25 日 | [创建直邮投递](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/direct-mail/creating-direct-mail-deliveries.html) | Campaign Classic | 了解直邮在 Adobe Campaign 中的工作方式，并了解如何创建和执行直邮投递，以及编排其格式。 |
