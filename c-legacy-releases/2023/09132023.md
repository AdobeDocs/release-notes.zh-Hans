...
| 2023 年 9 月 | AEM Forms | [记录 AEM Workflow 中的变量值](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html) | 文章 | 记录 AEM 工作流变量的值。这有助于开发人员跟踪和了解 AEM 工作流的执行情况、诊断问题以及监控 AEM 工作流中的数据流。 |
