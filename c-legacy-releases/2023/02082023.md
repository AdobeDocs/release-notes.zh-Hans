...
>[!IMPORTANT]
>
>Adobe 建议您[升级到 Experience Manager 增强连接器的最新 1.9.6 版本。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html)[!DNL Workfront]
