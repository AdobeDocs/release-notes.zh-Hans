...
* [[!UICONTROL 自适应表单向导]](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-an-adaptive-form/create-an-adaptive-form-on-forms-cs/creating-adaptive-form.html)：Experience Manager [!DNL Forms]提供便于企业用户使用的向导以快速创作[!UICONTROL 自适应表单]。该向导具有快速的选项卡导航，可轻松选择预配置的模板、样式、字段和提交选项以创建自适应表单。 此版本对向导进行了以下改进：
