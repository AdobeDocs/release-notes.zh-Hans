...
等等！请参阅 [Experience League 活动](https://experienceleague.adobe.com/events/)，查看完整时间表。
...
|2023 年 2 月|[配置 SMS API 凭据和渠道表面](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/set-up-sms-channel.html)|视频|了解如何将 Journey Optimizer 连接到 SMS 服务提供商以及如何创建 SMS 渠道表面。|
