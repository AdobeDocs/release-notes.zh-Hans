...
请前往 [Experience League](https://experienceleague.adobe.com/?lang=zh-Hans#home) 了解详情！
...
* 推出了面向 Dynamic Media 视频交付（已启用 CMAF）中的自适应流式处理的新协议（DASH – 基于 HTTP 的动态自适应流式处理）支持：
   ...
   * 在亚太地区和北美可用；[可通过提交支持票证启用。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html#enable-dash)即将在欧洲、中东和非洲推出。
...
* **[前端管道支持对基于核心组件的自适应表单进行样式设置](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/using-themes-in-core-components.html)**——将基于BEM的标准化主题用于基于核心组件的自适应表单。您可以使用前端部署管道部署它们，以增强表单的外观。它还可以帮助与您组织的品牌认可的设计指南保持一致。
...
* 当某个[证书](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html)到期时，将不再从 CDN 中删除与该证书关联的[域名](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/introduction.html)和 [IP 允许列表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/ip-allow-lists/introduction.html)。在这种情况下，该站点仍然可以访问。
* Cloud Manager UI 将显示更多醒目的警告，强调 [SSL 证书](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html)即将到期。
* 修复了客户无法创建或删除环境的罕见情况。
...
>[!IMPORTANT]
>
>Adobe 建议您将 Workfront for Experience Manager 增强型连接器[升级到最新的 1.9.9 版](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html)。
...
| 2023 年 5 月 | [了解增强分析中的资源容量图表](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/19-resource-capacity-chart.html) | 视频 | 了解资源容量图表如何显示筛选时间段内分配给主团队的计划小时数与团队的总可用小时数的比较。 |
...
| 2023 年 5 月 | [了解增强分析中的团队能力](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/20-team-capacity-overview.html) | 文章 | 了解团队容量图表如何显示主团队超额分配或分配不足的情况。 |
