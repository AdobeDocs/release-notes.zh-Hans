...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|--------|---------|---------|
| 2023 年 4 月 | [AEM GraphQL 处理空值的变化](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21792.html?lang=zh-Hans) | 新文章 | 了解如何解决由于最近对 GraphQL 实现的改进而导致的应用程序代码（在 [!DNL Experience Manager as a Cloud Service] 内）中可能出现的意外行为。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
|---------|----|----|-----------|
| 2023 年 4 月 | [从值超过 255 个字符的外部数据库中检索数据](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21880.html?lang=zh-Hans) | 新文章 | 了解如何从值超过 255 个字符的外部数据库中检索数据。 |
| 2023 年 4 月 | [错误：[!DNL Google BigQuery]外部账户&#x200B;_](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21895.html?lang=zh-Hans)中的_ XSV-350064 | 新文章 | 了解如何修复有关[!DNL Google BigQuery]外部账户&#x200B;_中的_ XSV-350064 错误。 |
| 2023 年 4 月 | [版本 9356：升级](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21907.html?lang=zh-Hans)后， [!DNL Internet Explorer]  中的外部链接仍然打开 | 新文章 | 了解如何解决升级到 9356 后外部链接仍然指向 [!DNL Internet Explorer] 而不是 [!DNL Microsoft Edge] 的问题。 |
