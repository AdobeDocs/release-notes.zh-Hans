...
* 通过优化模板中的图像大小设置，进一步减少访问者的页面加载时间。 有关图像组件的更多信息，请访问 [核心WCM组件](https://github.com/adobe/aem-core-wcm-components).
