...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 1 月 | [将价值归因于客户历程中的数字接触点](https://experienceleague.adobe.com/docs/courses/using/analytics-u-1-2022-2-1-0.html?lang=zh-Hans) | 课程 | 获知应从哪些主要方面了解您的网站访客。 了解促使他们访问您网站的因素，如何将您网站的转化积分分配给不同的渠道，以及您网站上的其他项目如何推动转化。 |
...
| -----------| ---------- | ---------- | ---------- |---------- |
|October 2022|[Getting started with decision management for marketers](https://experienceleague.adobe.com/docs/courses/using/experienceplatform-u-1-2020-1-offerdecisioning.html?lang=zh-Hans)|Video |Learn how to use enumerated fields and suggested values to create friendly dropdown menus in the segment builder interface.|Campaign v8|
