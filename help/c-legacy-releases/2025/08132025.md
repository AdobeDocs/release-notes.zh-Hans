...
| 产品 | 资源 | 描述 | 发布日期 |
| ------- | ------- | ------- | ------- |
| [!DNL AI Assistant in Marketo Email Designer] | [电子邮件设计器](https://experienceleague.adobe.com/zh-hans/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant?lang=en) | Marketo Engage 电子邮件设计器中的 AI 助手可帮助您创建现代、高效且直观的电子邮件。 这是通过Adobe的创作AI技术和提示库以及图像生成Firefly来实现的，该图像生成可帮助为特定角色/购买群体、营销历程阶段、沟通策略、语调等创建合适的内容。还可以使用特定的品牌资产来创建内容。 | 2025 年 8 月 |
...
| 功能 | 描述 |
| ------- | ------- |
| **虚拟助手全面可用** | <ul><li>**[!UICONTROL 虚拟助手]**&#x200B;使 Adobe Status 客户能够在网页或移动端直接找到答案并执行快速操作，而无需离开主页。 这是一个帮助您快速获取帮助和完成任务的统一地点。 </li><li>虚拟助手现已向所有 Adobe Status 客户开放。 您可以登录 [status.adobe.com](https://status.adobe.com/zh-cn/)，然后通过&#x200B;**[!UICONTROL 询问我们的助手]**&#x200B;小组件使用该功能。</li></ul> |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2025 年 8 月 | [CJA 中的工作区评论功能](https://experienceleague.adobe.com/zh-hans/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/workspace-projects/workspace-commenting) | 视频教程 | 了解 Adobe Customer Journey Analytics 中的 Workspace 评论功能如何让您和团队直接在您的数据上协作。 在不离开分析环境的情况下即可提问、分享洞察并达成共识。 |
...
| 2025 年 8 月 | [!DNL Journey Optimizer] | [在 Journey Optimizer 中设置 RCS](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/set-up-rcs) | 视频教程 | 了解如何在 Adobe Journey Optimizer 中使用自定义短信提供商配置并发送品牌化的交互式 RCS 消息。 |
| 2025 年 8 月 | [!DNL Journey Optimizer] | [在营销活动中利用消息优化](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/create-campaigns/action-campaigns/leverage-message-optimization-in-a-campaign) | 视频教程 | 了解如何在操作或 API 触发的营销活动中利用消息优化。 您将了解如何定位子受众、按位置创建消息变体、启用备用内容以及在单个营销活动中运行多个实验。 |
