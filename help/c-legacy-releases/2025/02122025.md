...
[了解详情……](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-cloud/discover-smarter-faster-learning-with-experience-league-s-new/td-p/739750?profile.language=zh-Hans)
...
| 发布日期 | 应用程序 | 名称 | 类型 | 描述 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2025 年 2 月 | [!DNL AI Assistant] | [通过 AI 助手获取运营洞察](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/ai-assistant/operational-insights) | 新视频 | 了解如何使用 [!DNL AI Assistant] 在 Adobe 中发掘有关业务对象（例如受众、数据集、模式、目标和历程）的运营洞察。[!DNL Experience Platform] |
...
| 2025 年 2 月 | [创建智能题注](https://experienceleague.adobe.com/zh-hans/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/intelligent-captions) | 新视频 | 了解如何在可视化效果中启用智能字幕，以便自动为您生成关于数据的自然语言洞察。 |
