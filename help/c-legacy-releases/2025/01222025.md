...
[Experience League](https://experienceleague.adobe.com/zh-hans?lang=zh-hans#home) 可帮助您了解 Experience Cloud 和 Adobe 企业应用程序。 为了获得最佳体验，请登录并在我们的免费资源库中自定义搜索，其中包括：

* [产品文档](https://experienceleague.adobe.com/zh-hans/docs)
* [视频播放列表](https://experienceleague.adobe.com/zh-hans/playlists)
* [活动](https://experienceleague.adobe.com/events/?lang=zh-Hans)
* [社区论坛](https://experienceleaguecommunities.adobe.com/?profile.language=zh-Hans)
* [支持](https://experienceleague.adobe.com/zh-hans?support-tab=home#support)

**提供反馈：**&#x200B;查找&#x200B;**_此内容是否有帮助？_** 在每篇文章或视频底部的弹出窗口。 您的反馈将被整理并发送给内容作者。
...
| 日期 | 功能 | 描述 |
| -----------| -----------| ---------- |
| 9 年 1 月 | 产品使用数据 | 为了更轻松地控制 [!DNL Experience Cloud] 产品使用数据偏好设置，我们简化了 [!DNL Experience Cloud] [偏好设置](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/features/account-preferences) 页面，以删除重复的选项。 通过这种简化，我们保留了当前用户偏好设置，您可以随时通过 [Experience Cloud 偏好设置](https://experience.adobe.com/preferences) 更新您的偏好设置。 |
...
| 2025 年 1 月 | [AEP Web SDK 故障排除、质保、提示和技巧](https://experienceleague.adobe.com/zh-hans/docs/events/tech-sessions/2024/rtcdp-office-hours-2024/aep-web-sdk-troubleshooting) | 活动 | 深入洞察 Adobe [!DNL Experience Platform] （AEP）Web SDK 的故障排除、质保以及提示和技巧。 |
...
* [&#x200B; [!DNL Experience Manager] as a Cloud Service的最新发行说明](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current)
...
| 2024 年 11 月 | [图像预览无法正常使用](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-25297) | 新文章 | 了解如何解决以下问题：调整 JPEG 质量设置时 [!DNL Adobe Experience Manager (AEM) as a Cloud Service] 中的图像预览不正常工作。 |
...
| 2024 年 12 月 | [请帮我找出谁从 [!DNL Dynamic Media] / [!DNL Scene7]](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-25461) 删除了图像 | 新文章 | 了解如何解决以下问题：客户的资产本应存在于网站上，但却丢失了。 |
...
| 2025 年 1 月 | [自定义地址表单版面和 Google 地址查找集成](https://experienceleague.adobe.com/zh-hans/docs/commerce-learn/tutorials/edge-delivery-services/getting-started/customize-address-new-account-link) | 视频 | 了解如何自定义结账时的地址表单版面，以确保所有字段的宽度均为 50%，文本区域除外。 |
...
* 请参阅 [[!DNL Journey Optimizer B2B Edition]](https://business.adobe.com/cn/products/journey-optimizer-b2b-edition.html) 了解产品信息。
...
* [Journey Orchestration文档](https://experienceleague.adobe.com/zh-hans/docs/journeys/using/journey-orchestration-home)
