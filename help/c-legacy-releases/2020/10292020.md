...
| 2020 年 11 月 2 日 | [集成 Adobe Experience Manager 和 Adobe Analytics 以收集页面数据](https://video.tv.adobe.com/v/3410060?captions=chi_hans) | 视频 | 本课程将指导您完成关于以下内容的分步教程：如何通过使用客户端数据层收集页面数据，然后在 Adobe Analytics 中创建 Analysis Workspace 项目，将 Adobe Analytics 与 Adobe Experience Manager Sites 集成以了解页面上的用户行为。 |
