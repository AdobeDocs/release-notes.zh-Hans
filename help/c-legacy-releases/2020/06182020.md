...
| 内容 | 内容类型 | 描述 |
| -----------| ---------- | ---------- |
| [Adobe Experience Platform 简介](https://experienceleague.adobe.com/?lang=zh-hans&recommended=ExperiencePlatform-U-1-2020.1) | 课程 | 了解 Adobe Experience Platform 如何通过将数据转换为强大的实时客户轮廓和 AI 驱动的洞察（可在每个渠道中激活）来帮助您提供正确的体验。 此入门级课程概述了 Experience Platform 的功能、用例、与 Adobe Experience Cloud 的关系、基本架构、界面和项目角色。 |
...
| [!UICONTROL 工作区]中的“快速洞察”面板 | 2020 年 6 月 25 日 | “快速洞察”可为 [!UICONTROL Analysis Workspace] 的非分析师用户和新用户了解如何快速轻松地回答业务问题提供指导。 [了解更多...](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/panels/quickinsight.html?lang=zh-Hans) |
| [!UICONTROL 关于 Workspace] 页面 | 18,2020 年 6 月 | [!UICONTROL 关于 Workspace] 页面提供了有关您的 Analysis Workspace 环境、Adobe Analytics 管理员（如果您需要支持）的信息，以及提交产品反馈的方法。 可按照以下路径找到该页面：**[!UICONTROL Workspace]** > **[!UICONTROL 帮助]** > **[!UICONTROL 关于 Workspace]**。 |
...
| 功能 | [正式发布](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=zh-Hans) - 目标日期 | 描述 |
| ----------- | ---------- | ---------- |
| [支持的设备和平台](https://experienceleague.adobe.com/docs/media-analytics/using/supported-devices.html?lang=zh-Hans) | 2020 年 6 月 18 日 | Media Launch Extension w/ AEP SDK 现在支持以下 OTT 设备：<ul><li>Apple TV (tvOS)</li><li>Fire TV (Fire OS)</li><li>Android TV</li></ul> |
...
| [适用于领导者的 Adobe Analytics 基础知识](https://experienceleague.adobe.com/?lang=zh-hans&recommended=Analytics-L-1-2020.1) | 课程 | 在此课程中，了解 Analytics 的基础知识以及 Analysis Workspace 如何改变您的业务。 了解如何通过Adobe AI发掘见解、听取客户评价并观看2019年峰会行业专家的重要演讲。 |
...
* **AEM6.5.5.0**
  ...
  * [AEM Forms发布交付内容](https://helpx.adobe.com/cn/aem-forms/kb/aem-forms-releases.html)
...
* **辅助功能和 WCAG 2.1 准则**
  ...
  * [Adobe Experience Manager as a Cloud Service和Web无障碍准则](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html?lang=zh-Hans)
  * [WCAG 2.1快速指南](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/accessibility/quick-guide-wcag.html?lang=zh-Hans)
  * [创建无障碍内容（WCAG 2.1合规性）](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html?lang=zh-Hans)

### **社区**

* **AEM 社区讨论**

  现在，您可以在一个位置查看所有 AEM 公告以及对内部和外部博客作者的相关引用。 请参阅 AEM 社区的[“讨论”部分。](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/bd-p/adobe-experience-manager-discussions?profile.language=zh-Hans)
