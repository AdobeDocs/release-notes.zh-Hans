...
* 使用 Adobe ID，可以根据您的产品、所在的地区和事件偏好设置订阅事件通知。配置订阅偏好设置的用户，仅在打开、更新或关闭相关的产品事故和维护事件时，才会收到通知。要开始使用，请访问 [status.adobe.com/subscriptions](https://status.adobe.com/zh-cn/proactive-notifications/subscriptions/edit)。
...
* **新增功能：AEM as a Cloud Service**
  ...
  [Adobe Experience Manager](https://business.adobe.com/cn/products/experience-manager/adobe-experience-manager.html) (AEM) 现已作为 Cloud Service 提供。
