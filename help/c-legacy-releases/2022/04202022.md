...
| 2022 年 4 月 | [用数据讲述有影响力的故事](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/telling-impactful-stories-with-data.html) | 视频 | 用数据讲故事是艺术和科学结合了使用数据、可视化和叙述的产物。 通过有效地用数据讲述故事，Adobe Analytics 可以变得更容易被更广泛的受众所接受，并且您可以通过数据驱动型决策提高您为组织带来的价值。 |
| 2022 年 4 月 | [获得话语权](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/gaining-a-seat-at-the-table.html) | 视频 | 了解您作为 Analytics 管理员的角色，并获取有关如何获得专业知识的提示，帮助您在业务决策表中占据一席之地。 |
| 2022 年 4 月 | [以非技术方式翻译 Adobe Analytics 技术语言](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/translating-adobe-analytics-technical-language.html#) | 视频 | 您作为组织中的 Adobe Analytics 专家，对于帮助利益相关者了解技术细节并充分利用您的 Adobe Analytics 投资将发挥关键作用。 |
| 2022 年 4 月 | [Analysis Workspace 中的快速区段](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/quick-segments-in-analysis-workspace.html) | 视频 | _快速区段_&#x200B;是直接在 [!UICONTROL Workspace] 画布中进行的简化分段体验。 了解如何使用最多三个规则构建即时区段，而无需离开您的分析工作流。 |
| 2022 年 4 月 | [Analysis Workspace 中的注释](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/annotations-in-analysis-workspace.html) | 视频 | 了解如何使用已知数据问题、公共假日和营销活动启动次数来对日期或日期范围添加批注，以便更好地告知用户为何会在折线图、表格等中看到内容。 |
| 2022 年 4 月 | [跨职能工作](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/working-cross-functionally.html) | 视频 | 向 Adobe Analytics 冠军学习如何在您的组织中跨职能工作。 |
...
* [!DNL Streaming Media Analytics] [发行说明](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html)（**新位置**）
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 4 月 | [配置数据视图以进行Customer Journey Analytics概述](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/overview-of-configuring-data-views-for-cja.html) | 视频 | 了解配置 [!UICONTROL 数据视图] Customer Journey Analytics。 [!UICONTROL 数据视图] 类似于 [!UICONTROL 虚拟报告包] 在Adobe Analytics。 利用这些功能，可配置传入数据，以便其对您的报告和分析最有用。 |
| 2022 年 4 月 | [CJA中的连接详细信息体验](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections-details-experience-in-cja.html) | 视频 | 了解如何检查连接的数据集的状态和引入过程的状态。 |
...
* **Experience Manager Assets as a Cloud Service**
  ...
  * Experience Manager Dynamic Media 现在提供了灵活性，让您可以在用户界面中[配置一个别名帐户](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dm-alias-account.html)，从而确保开箱即用的 [!UICONTROL Dynamic Media] URL 和查看器嵌入代码获得更新。 此更新对 SEO 产生积极影响，以反映对您的业务环境（如品牌再造）所做的更新。
  * 您现在可以使用 Experience Manager Assets 用户界面执行以下操作：
    * 在存储库中配置[重复资产检测](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets.html#detect-duplicate-assets)。
    * 配置[添加数字水印](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/watermark-assets.html)到图像。
  ...
  * [管理发布](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-publication.html)功能通过改进的用户界面得到增强。 用户可将内容发布到所选目标或从所选目标取消发布内容，或向 DAM 存储库中的发布列表[添加内容](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-publication.html#add-content)。 它们可以[包括文件夹设置](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-publication.html#include-folder-settings)以发布所选文件夹的内容并应用过滤器，以及[将发布安排](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-publication.html#publish-assets-later)到以后的日期或时间。

    _Experience Manager Assets 预发行渠道中的新增功能_

  * 在创建智能标记和使用标记谓词应用搜索过滤器时，可[为标记排序](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/organize-assets.html#use-tags-to-organize-assets)。

* **Experience Manager Forms as a Cloud Service**

  _Forms 的新增功能_

  * **通信 — 文档生成API** — [文档生成API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications.html) 帮助合并、重新排列和验证PDF文档。 该服务允许您以同步模式生成文档。 通过这些 API，可创建应用程序以执行以下操作：
...
* **Experience Manager as a Cloud Service 基础**
  ...
  * 为了更加高效和有效地为云环境中的自定义功能排除故障，Adobe 已发布一个新的开发人员工具：[存储库浏览器](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/repository-browser.html)。 它是一个可从开发人员控制台启动的轻型只读 HTML 浏览器。 在发布者、作者和预览层面上以及所有环境（包括生产、暂存和开发）中了解内容存储库。 浏览内容结构，查看属性，预览和下载二进制文件。
  * 现在可从开发人员控制台中自助刷新用于对服务器到服务器的 API 调用（例如，用于 GraphQL API 请求）验证身份的凭据以免其过期。 如需更多信息，请参阅[此](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/generating-access-tokens-for-server-side-apis.html#refresh-credentials)文档。
  * 现在为新环境启用了以前尚未启用的版本清除和审核日志清除维护任务。 请参阅[维护任务](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/maintenance.html)文章中的相关值。
...
* **Cloud Manager**
  ...
  Experience Manager as a Cloud Service 2022.02.0 中的 Cloud Manager 的发布日期是 2022 年 2 月 10 日。
  下一个版本计划于 2022 年 3 月 10 日发布。

  _新增功能_

  * 新加速的[&#x200B; Web 层配置管道](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#web-tier-config-pipelines)已引入，专门部署 HTTPD/Dispatcher 配置。

    * 必须在 AEM 版本 `2021.12.6151.20211217T120950Z` 或更高版本上，并[选择加入 Dispatcher 工具的灵活模式](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html#validation-debug)才能使用此功能。
    * 打算在发布 2022.02.0 后两周内分阶段推出此功能。

  * Cloud Manager 登陆页面体验已刷新，以提供改进的导航、网格/平铺视图之间的轻松切换，以及快速程序摘要的弹出窗口。
  * 已将一个新的失败阈值 (`< D`) 添加到[可靠性评价指标](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/code-quality-testing.html#understanding-code-quality-rules)。

    * 客户如遇到影响系统稳定性的严重质量问题（主要与无效索引和工作流程有关），则直到解决了这些问题后才能部署。
  * BannedPath [质量规则](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/code-quality-testing.html#understanding-code-quality-rules)的严重性已从 blocker 变为 critical。
  * 管道向导会在配置与之关联的[&#x200B; Web 层配置管道](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#web-tier-config-pipelines)之前，告知用户何时可能需要更新 Experience Manager 环境。
...
* **即将召开的Experience Manager GEM网络研讨会**
  ...
  * 主题：_集成 AEM 和 CIF 框架，打造丰富而沉浸式的电子商务体验_
    ...
    * 时间：太平洋夏令时间上午8:00 /下午5:00 CET /晚上8:30 IST
...
| 2022 年 4 月 | [使用调用 DDX 操作来组合 PDF](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-assembler/introduction.html) | 视频 | 存储库浏览器是一款功能强大的工具，可显示 AEM 基础数据存储，从而轻松调试 AEM as a Cloud Service 环境。 存储库浏览器支持在生产、暂存和开发以及创作、发布和预览服务中检查 AEM 的所有资源和属性。 | AEM CS |
| 2022 年 4 月 | [实施解决方案以保存和检索信件实例](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-retrieve-letters/introduction.html) | 视频 | 了解如何使用 SPI 实施以保存和检索交互式通信的信件实例。 | AEM Forms |
| 2022 年 4 月 | [创建和验证 PDF/A 文档](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-assembler/pdfa-utilities.html) | 视频 | 了解如何创建和验证 PDF/A 文档。 PDF/A 是可移植文档格式 (PDF) 的 ISO 标准化版本，专门用于电子文档的归档和长期保存。 | AEM Forms |
| 2022 年 4 月 | [集成 AEM Forms 与 [!DNL ServiceNow]](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/service-now.html) | 视频 | 在 ServiceNow 中使用 AEM Forms 中的表单数据模型创建和显示事件。 | AEM Forms |
...
* [Adobe Commerce和Magento Open Source 2.4.x发行说明](https://devdocs.magento.com/guides/v2.4/release-notes/bk-release-notes.html)
...
| 2022 年 4 月 | [[!DNL Site-Wide Analysis Tool]](https://experienceleague.adobe.com/docs/commerce-operations/tools/site-wide-analysis-tool/intro.html) | 文档 | 有关 [!DNL Site-Wide Analysis] 工具，包括其用途、安装过程和获取访问权限。Adobe Commerce |
...
| 2022 年 4 月 | [审核记录](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/monitoring/audit-trail.html) | 视频 | 了解如何访问审核记录日志以及可以配置的设置。 | Campaign v8 |
...
| 2022 年 4 月 | [Assets Essentials概述](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/assets-essentials-overview.html) | 视频 | 获取有关 Assets Essentials 功能以及如何在 Adobe Journey Optimizer 中使用该功能的概述。 |
| 2022 年 4 月 | [历程画布概述](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/overview-over-the-journey-canvas.html) | 视频 | 了解历程画布的特性和功能。 |
| 2022 年 4 月 | [统一的用户轮廓和分段](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/profiles-segments-subscriptions/unified-profile-and-segmentation-overview.html) | 视频 | 了解如何创建统一的用户轮廓，然后根据轮廓属性构建区段，以使客户历程个性化。 |
...
| 2022 年 4 月 | [创建个性化产品建议](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management-configuration/create-personalized-offers.html) | 视频 | 了解如何在 Offer Decisioning 中创建个性化产品建议。 个性化产品建议具有与其相关联的资格规则，可帮助您仅向相关客户显示这些产品建议。 |
| 2022 年 4 月 | [创建标记](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management-configuration/create-tags.html) | 视频 | 了解如何在 Offer Decisioning 中创建标记。 标签是产品建议的可选构建基块组件。 它们可用于组织产品建议并将其分组到动态集合中。 |
| 2022 年 4 月 | [决策管理能力演示](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management-configuration/demo-of-offer-decisioning.html) | 视频 | 了解各品牌可怎样使用决策管理功能定义和管理其产品建议、应用实时客户数据以及投放其客户期望的适当体验。 |
...
| [!UICONTROL 广告洞察] | 除[!UICONTROL 查询交叉匹配]和[!UICONTROL 混合项目组合设置准备工作]之外的所有洞察现在均已退出 Beta 测试版。 |
| [!UICONTROL 营销活动]<br><br>[!UICONTROL 广告洞察] | (4月11日； [!DNL Google Ads] 帐户)Advertising Cloud Search已过渡了旧版中的所有API调用 [!DNL Google AdWords API] 最新 [!DNL Google Ads API]. 迁移到新 [!DNL Google Ads API] 确保与现有功能保持连续性，并允许访问 [!DNL Google's] 最新 [!DNL Ads] 功能。<br><br>某些功能尚未更新到新API，暂时不可用：<ul><li>位置扩展：<ul>位置扩展在 [!UICONTROL 扩展] 中。</li><li>无法创建扩展。</li><li>位置上的过滤器不起作用。</li></li></ul><li>[!UICONTROL 广告洞察]:的 [!UICONTROL 展示共享丢失] 和 [!UICONTROL 查询交叉匹配测试版] 分析不可用。</li></ul>我们预计将在4月底之前恢复位置扩展功能。 确定受影响的 [!UICONTROL 广告洞察] 模块也可以恢复，我们将发送包含估计日期的更新。 |
...
| 2022 年 4 月 | [发送后修改文档](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight.html) | 视频 | 了解如何修改已发出供签名的文档 - 例如，在误发文档时。 | Adobe Sign |
| 2022 年 4 月 | [设置签名顺序](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/setting-up-routing.html) | 视频 | 了解如何为多个签名者设置签名顺序。 按顺序和/或并行方式发送文档，或将文档发送给特定的个人组。 | Adobe Sign |
