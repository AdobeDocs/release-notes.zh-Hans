...
观看 [2022 年 8 月发布概述视频](https://video.tv.adobe.com/v/3454206/?captions=chi_hans&quality=12)，了解 2022.8.0（2022 年 8 月）版本中新增功能摘要。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->

* [2022 年 7 月发行版概述视频](https://video.tv.adobe.com/v/3454206/?captions=chi_hans&quality=12)
...
| [!UICONTROL 广告洞察] | [!UICONTROL 广告洞察]视图具有全新外观和工作流程，其基于新基础架构，提高了性能和可靠性。 现在，只需点击洞察名称，选择或输入设置，然后点击[!UICONTROL 生成洞察]。<br><br>要暂时返回到旧视图，请启用右上角的[!UICONTROL 切换到旧 UI]。 旧视图将在 9 月底删除。 |
