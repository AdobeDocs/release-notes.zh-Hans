...
观看 [2022 年 7 月发行版概述视频](https://video.tv.adobe.com/v/3452359/?captions=chi_hans&quality=12)，了解 2022.7.0（2022 年 7 月）发行版中新增功能摘要。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
| 2022 年 8 月 | [AEM Headless 教程](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html?lang=zh-Hans) | 更新后的文章 | AEM Headless SDK教程已更新为使用持久查询和WKND 2.0。 使用动手实践教程以了解如何使用各种选项并选择适合您的选项。 | AEM as a Cloud Service |
...
* [Campaign v7.3发行说明](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=zh-Hans)
