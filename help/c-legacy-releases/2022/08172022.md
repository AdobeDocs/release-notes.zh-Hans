...
* `mod_macro`现已在Experience Manager as a Cloud Service中可用。[有关支持的Apache模块的列表，请参阅此表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html)。
...
| 2022 年 8 月 | [AEM Headless 教程](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html) | 更新后的文章 | AEM Headless SDK教程已更新为使用持久查询和WKND 2.0。 使用动手实践教程以了解如何使用各种选项并选择适合您的选项。 | AEM as a Cloud Service |
...
| 2022 年 8 月 | [目录服务指南概述](https://experienceleague.adobe.com/docs/commerce-merchant-services/catalog-service/guide-overview.html) | 产品文档 | 大致了解[!UICONTROL 目录服务]。 了解入门和安装。 |
