...
* `mod_macro`现已在Experience Manager as a Cloud Service中可用。[有关支持的Apache模块的列表，请参阅此表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=zh-Hans)。
