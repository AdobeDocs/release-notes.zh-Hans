...
| 2022 年 6 月 | [整合 AEM 和 CIF 框架，打造丰富的沉浸式电子商务体验。](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2022/aem-and-cif-framework-integration.html) | 视频 | 了解 Adobe 的 CIF 框架如何用于构建一致且内容丰富的沉浸式商务体验。 | AEM 和 CIF 框架 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 6 月 | [MBI 快速入门](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/getting-started.html) | 视频 | 直接从 Commerce 产品团队了解 MBI 的核心功能，深入了解预配置的仪表板和可用的自定义选项。 |
| 2022 年 6 月 | [在 MBI 中管理数据集](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/manage-data-sets.html) | 视频 | 直接从 Adobe Commerce 产品团队了解 MBI 数据仓库管理器的一些强大功能。 超越基本的报告构建，了解如何利用您的数据做更多事情。 |
| 2022 年 6 月 | [优化您的 MBI 数据仓库](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/optimize-data-warehouse.html) | 视频 | 了解如何管理表和列同步设置、深入分析表的架构以及创建计算列以在报告中使用。 |
| 2022 年 6 月 | [MBI 为假期做好准备](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/holiday-readiness.html) | 视频 | 了解常见的季节性分析用例和使用关键 MBI 功能解决这些问题的方法。 |
| 2022 年 6 月 | [MBI – 咨询专家](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/ask-expert.html) | 视频 | 在这个由两部分组成的网络研讨会中，了解客户对 Business Intelligence 的看法。 通过 Business Intelligence 学习业务转型、使用公用表格表达式进行 SQL 优化等等。 |
