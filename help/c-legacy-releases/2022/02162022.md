...
* Adobe Status 现在报告产品级别的事件。状态云和产品页面具有新外观和基于产品级事件报告的增强过滤器。这让您更容易地在 [status.adobe.com](https://status.adobe.com/zh-cn/) 和电子邮件通知中了解您的产品受到什么影响。如果您未订阅，请使用此链接设置个性化订阅偏好 [https://status.adobe.com/zh-cn/proactive-notifications/manage](https://status.adobe.com/zh-cn/proactive-notifications/manage)
